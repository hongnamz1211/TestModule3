            ...
            <form action="/product?action=editPost&id=${productEdit.getId_product()}" method="post">
                <table>
                    <tr>
                        <th>Name:</th>
                        <td>
                            <input type="text" name="name" size="60" value="${productEdit.getName()}"/>
                        </td>
                    </tr>
                    <tr>
                        <th>Price:</th>
                        <td>
                            <input type="text" name="price" size="60" value="${productEdit.getPrice()}"/>
                        </td>
                    </tr>
                    <tr>
                        <th>Quantity:</th>
                        <td>
                            <input type="text" name="quantity" size="60" value="${productEdit.getQuantity()}"/>
                        </td>
                    </tr>
                    <tr>
                        <th>Color:</th>
                        <td>
                            <input type="text" name="color" size="60" value="${productEdit.getColor()}"/>
                        </td>
                    </tr>
                    <tr>
                        <th>Description:</th>
                        <td>
                            <input type="text" name="description" size="60" value="${productEdit.getDescription()}"/>
                        </td>
                    </tr>
                    <tr>
                        <th>Category:</th>
